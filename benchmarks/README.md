...
The target is an M5Stack Core2 v1.1 with ESP32 revision 3.1, 240 MHz CPU,
40 MHz display SPI, and 40 MHz PSRAM. Each result uses five warmup frames and
100 measured frames. The accepted full-frame transfer limits are 35 ms median,
38 ms p95, 42 ms p99, at least 28 FPS, and zero errors.

Validate a captured JSONL file with:

```sh
scripts/check-display-benchmark.sh benchmarks/results/2026-07-11-raw-16k-40mhz.jsonl
```
