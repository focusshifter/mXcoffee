#ifndef OEPPRESSURE_H
#define OEPPRESSURE_H
#include "BLEUtils.h"
...
#define BLE_PRESSURE_DESCRIPTOR                                                \
  BLEUUID((uint16_t)ESP_GATT_UUID_CHAR_DESCRIPTION)
#define BLE_PRESSURE_ZERO_CHARACTERISTIC "873ae82c-4c5a-4342-b539-9d900bf7ebd0"
#define BLE_PRESSURE_ZERO_DESCRIPTOR                                           \
  BLEUUID((uint16_t)ESP_GATT_UUID_CHAR_DESCRIPTION)
