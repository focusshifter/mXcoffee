...
void UI::drawGraph() {
    ...
    if (batteryLevel > 25) canvas->setTextColor(TFT_GREEN, TFT_BLACK);
    else if (batteryLevel > 15) canvas->setTextColor(TFT_YELLOW, TFT_BLACK);
    else if (batteryLevel > 5) canvas->setTextColor(TFT_ORANGE, TFT_BLACK);
    else canvas->setTextColor(TFT_RED, TFT_BLACK);
