...
public:
    ...
    virtual void fillSprite(uint32_t color) = 0;
    ...
    virtual void drawFastHLine(int16_t x, int16_t y, int16_t w,
                               uint32_t color) = 0;
    virtual void drawString(const String& string, int16_t x, int16_t y) = 0;
    virtual void drawRightString(const String& string, int16_t x, int16_t y) = 0;
    virtual void drawCenterString(const String& string, int16_t x, int16_t y) = 0;
    virtual void setFont(const void *font) = 0;
    virtual void loadFont(const uint8_t* array) = 0;
    virtual void setTextColor(uint32_t fg, uint32_t bg) = 0;
    virtual uint32_t color888(uint8_t r, uint8_t g, uint8_t b) = 0;
