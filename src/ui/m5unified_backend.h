...
public:
    M5UnifiedCanvas(M5GFX* display);
    ~M5UnifiedCanvas();
    void createSprite(int16_t width, int16_t height) override;
    void deleteSprite(); // Add declaration for deleteSprite()
